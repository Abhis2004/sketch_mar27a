...
const char *ssid = "S10";  // Replace with your WiFi SSID
const char *password = "freepass";   // Replace with your WiFi password
...
void initCamera() {
  ...
  // if (psramFound()) {
  //   config.frame_size = FRAMESIZE_SVGA;  // Change to SVGA for testing
  //   config.jpeg_quality = 12;              // Adjust quality
  //   config.fb_count = 2;                   // Use 2 frame buffers
  // } else {
  //   config.frame_size = FRAMESIZE_QVGA;   // Change to QVGA if no PSRAM
  //   config.jpeg_quality = 12;              // Adjust quality
  //   config.fb_count = 1;                   // Use 1 frame buffer
  // }

  if (psramFound()) {
    config.frame_size = FRAMESIZE_240X240;  // Set to 240x240 for better quality
    ...
    config.fb_count = 2;                  // Use 2 frame buffers
    config.grab_mode = CAMERA_GRAB_LATEST;
    // config.frame_size = FRAMESIZE_QVGA;   // Set to 320x240 if no PSRAM
    // config.jpeg_quality = 12;              // Adjust quality
    // config.fb_count = 1;                   // Use 1 frame buffer
  }
